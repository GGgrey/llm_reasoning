...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default="internlm2-1_8b-reward", help="Model name to be used (default: 'Qwen2.5-7B')")
    parser.add_argument('--port', type=int, default=8000, help="Port to run the FastAPI service on (default: 8000)")
    parser.add_argument('--gpu_memory_utilization', type=float, default=0.25, help="GPU memory utilization percentage (default: 0.45)")
