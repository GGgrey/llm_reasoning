...
def extract_last_question(cot_prompt):
    ...
    if len(question_or_claim_matches) > 0:
        last_question_or_claim_index = cot_prompt.lower().rfind("question:") if "question:" in cot_prompt.lower() else cot_prompt.lower().rfind("claim:")
...
def extract_last_answer(cot_prompt):
    ...
    if len(answer_matches) > 0:
        last_answer_index = cot_prompt.lower().rfind("answer:")
